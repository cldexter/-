...
def log(when, who, identifier, action, result, info_type):  # 用于日志的信息
    if wconfig.log_protocol == 9:
        mh.add_new_log(when, who, identifier, action, result, info_type)
    elif wconfig.log_protocol == 5 and info_type in ["important", "error", "notice", "debug", "info"]:
        mh.add_new_log(when, who, identifier, action, result, info_type)
    elif wconfig.log_protocol == 4 and info_type in ["important", "error", "notice", "info"]:
        mh.add_new_log(when, who, identifier, action, result, info_type)
    elif wconfig.log_protocol == 3 and info_type in ["important", "error", "notice"]:
        mh.add_new_log(when, who, identifier, action, result, info_type)
    elif wconfig.log_protocol == 2 and info_type in ["important", "error"]:
        mh.add_new_log(when, who, identifier, action, result, info_type)
    elif wconfig.log_protocol == 1 and info_type == "important":
        mh.add_new_log(when, who, identifier, action, result, info_type)
    else:
        pass
...
def display(when, who, identifier, action, result, info_type):  # 用于显示的信息
    if wconfig.display_protocol == 9:
        screen.add_new_display(when, who, identifier,
                               action, result, info_type)
    elif wconfig.display_protocol == 5 and info_type in ["important", "error", "notice", "debug", "info"]:
        screen.add_new_display(when, who, identifier,
                               action, result, info_type)
    elif wconfig.display_protocol == 4 and info_type in ["important", "error", "notice", "info"]:
        screen.add_new_display(when, who, identifier,
                               action, result, info_type)
    elif wconfig.display_protocol == 3 and info_type in ["important", "error", "notice"]:
        screen.add_new_display(when, who, identifier,
                               action, result, info_type)
    # 只记录错误
    elif wconfig.display_protocol == 2 and info_type in ["important", "error"]:
        screen.add_new_display(when, who, identifier,
                               action, result, info_type)
    elif wconfig.display_protocol == 1 and info_type == "important":
        screen.add_new_display(when, who, identifier,
                               action, result, info_type)
    else:
        pass
